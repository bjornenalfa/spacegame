...
function love.load()
  ...
  planetDuoBase = planet.new( 1,   150,  0,   270,  0.5,   100000,  {0, 0, 0},  image.planet_3)
  ...
  planet3 = planet.new( 8e6,    270,  20,   90,   1,      100,  {0, 0, 250},      image.planet_3)
  planet4 = planet.new( 15e6,   800,  40,   180,  0.15,   100,  {100, 100, 100},  image.planet_4)
